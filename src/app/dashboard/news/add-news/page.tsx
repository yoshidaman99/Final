        ...
        <div>
            <HeaderInfo title={metadata.title != null ? metadata.title.toString() : ''} bg_color='bg-[#F9DBBB]' text_color='text-[#2E3840]' />
                ...
                <div className='rounded border-2 border-gray-900 my-4 mx-20 p-5 bg-[#fafafa]'>
                        ...
                        <div className='mt-4'>
                            <input type="text" name="first-name" id="first-name" className="block w-full rounded-md border-0 py-1.5
                             text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset
                             focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4" autoComplete='given-name' placeholder='Title' />
                        </div>

                        <div className='mt-4'>
                            <input type='date' className='block py-1.5 rounded-md
                        ...
                        <div className='mt-4'>
                        <textarea className='w-full h-60 py-3 px-4 rounded-md placeholder:text-gray-400 ring-1 ring-inset
                             ...
                             <div className="col-span-full">
                                ...
                                <div className="text-center">
                                    <svg className="mx-auto h-12 w-12 text-gray-300" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                        ...
                                        112.25 0 1.125 1.125 0 01-2.25 0z" clip-rule="evenodd" />
                                    </svg>
                        ...
                        <div className='mt-4 pb-12'>
                            <button type="button" className='float-right inline-flex w-full justify-center rounded-none
                            bg-red-600 px-10 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto'>
                                        Publish
                            </button>
                        </div>
                </div>
